...
@section('title', 'Create Consent Form - Teacher Dashboard')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Create Consent Form</h1>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('teacher.consent-forms.store') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('scope') is-invalid @enderror" id="scope" name="scope" required>
                                    ...
                                    <option value="section" {{ old('scope') === 'section' ? 'selected' : '' }}>
                                        Section/Grade
                                    </option>
                                    <option value="class" {{ old('scope') === 'class' ? 'selected' : '' }}>
                                        Class-wide
                                    </option>
                                </select>
                                @error('scope')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('recipient_type') is-invalid @enderror" id="recipient_type" name="recipient_type" required>
                            ...
                            <option value="section" {{ old('recipient_type') === 'section' ? 'selected' : '' }}>All students in section</option>
                            <option value="class" {{ old('recipient_type') === 'class' ? 'selected' : '' }}>All students in class</option>
                            <option value="students" {{ old('recipient_type') === 'students' ? 'selected' : '' }}>Specific student(s)</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('form_content') is-invalid @enderror" 
                                  id="form_content" name="form_content" rows="10" required>{{ old('form_content') }}</textarea>
                        @error('form_content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('teacher.consent-forms.index') }}" class="btn btn-secondary">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="{{ route('teacher.announcements.create') }}" class="btn btn-outline-info w-100">
