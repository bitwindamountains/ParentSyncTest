...
@section('title', 'Create Event - Teacher Dashboard')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('teacher.events.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('recipient_type') is-invalid @enderror" id="recipient_type" name="recipient_type" required>
                            ...
                            <option value="section" {{ old('recipient_type') === 'section' ? 'selected' : '' }}>Section/Grade</option>
                            <option value="class" {{ old('recipient_type') === 'class' ? 'selected' : '' }}>Class-wide</option>
                            <option value="students" {{ old('recipient_type') === 'students' ? 'selected' : '' }}>Specific Students</option>
                        </select>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('teacher.events.index') }}" class="btn btn-secondary">
        ...
        <div class="card shadow mt-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <h6>Scope Options:</h6>
                    <ul class="small text-muted">
                        <li><strong>General:</strong> All students and teachers</li>
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        <a href="{{ route('teacher.consent-forms.create') }}" class="btn btn-outline-warning w-100">
